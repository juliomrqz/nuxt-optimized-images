...
const logger = consola.withScope('nuxt:@bazzite/nuxt-optimized-images')
...
logger.missingOptimizePackages = () => {
  ...
  message += `\nFor help during the setup and installation, please read \`https://www.bazzite.com/docs/nuxt-optimized-images#optimization-packages\``
